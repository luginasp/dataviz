...
plot_household <- 
  plot_household +
  labs(
    title = "the world bank 2019",
    subtitle = "sanitasi dan elektrisitas",
    caption = "Author: luginasp \n Contact: luginasp98@gmail.com \n Data source: The World Bank, 2019",
    x = "electricity",
    y = "sanitation",
    colour = "year",
    size = "water"
...
``` r
logo <- image_read("../data-raw/telkom-university.png") # berkas logo dengan format png atau jpg, direktorinya
plot_household
grid::grid.raster(logo, x = 0.0, y = 0.0, just = c('left', 'bottom'), height = unit(0.5, 'inches'))
```
